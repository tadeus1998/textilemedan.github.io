...
<head>
    ...
    <title><?= $title; ?> | Aplikasi Pendataan Barang D'Fashion Textile & Tailor</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-light sidebar sidebar-secondary accordion shadow-sm" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex text-primary align-items-center bg-light justify-content-center" href="">
                <div class="sidebar-brand-text mx-3">D'Fashion Textile & Tailor</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-white bg-info topbar mb-4 static-top shadow-sm">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline small text-capitalize font-weight-bold">
                                    <?= userdata('nama'); ?>
                                </span>
                                <img class="img-profile rounded-circle border border-primary" src="<?= base_url() ?>assets/img/avatar/<?= userdata('foto'); ?>">
                            </a>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    ...
                    <strong>Copyright &copy; D'Fashion Textile & Tailor </strong> | Created by <strong><a href="#" class="text-primary">Lili Rahmita</a></strong> 
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
