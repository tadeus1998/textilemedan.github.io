...
class Laporan extends CI_Controller
{
    ...
    {
      // Mengambil nilai dari kolom tanda tangan
      $diketahui = $request->input('diketahui');
      $disetujui = $request->input('disetujui');
    
      // Melakukan sesuatu dengan nilai tanda tangan
      // ...
    ...
    private function _cetak($data, $table_, $tanggal)
    {
        ...
        if ($table_ == 'barang_masuk') :
            ...
            foreach ($data as $d) {
                ...
                $pdf->Cell(55, 7, $d['nama_supplier'], 1, 0, 'L');
        ...
        // Set position for "Diorder oleh" text
        $pdf->SetXY(0, 140);
        $pdf->Cell(50, 7, 'Dibuat oleh', 0, 0, 'C');
        $pdf->SetXY(0, 160);
        $pdf->Cell(50, 7, 'Admin', 0, 0, 'C');


        // Set position for "Disetujui oleh" text
        $pdf->SetXY(160, 140);
        $pdf->Cell(50, 7, 'Disetujui oleh', 0, 0, 'C');
        $pdf->SetXY(160, 160);
        $pdf->Cell(50, 7, 'Manager', 0, 0, 'C');
